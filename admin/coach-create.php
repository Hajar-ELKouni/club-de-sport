            ...
            <main class="container py-5">
                ...
                if (isset($_POST['create'])) {
                    ...
                    if (empty($errorArray)) {
                        ...
                        $createEquipe = $conn->prepare("INSERT INTO users(nom, prenom, date_naissance, gender, email, password,changed_password, bio, role,sport) VALUES(:nom, :prenom, :date_naissance, :gender, :email, :password, :changed_password, :bio, :role , :sport)");
                        $createCoach = $conn->prepare("INSERT INTO coach(nom, prenom, sport) VALUES(:nom, :prenom, :sport)");
                        ...
                        $createEquipe->bindValue("changed_password", 1);
                        $createEquipe->bindValue("bio", $bio);
                        $createEquipe->bindValue("role", $role);
                        $createEquipe->bindValue("sport", $sport);
                        $createCoach->bindValue("nom",$nom);
                        $createCoach->bindValue("prenom", $prenom);
                        $createCoach->bindValue("sport", $sport);
