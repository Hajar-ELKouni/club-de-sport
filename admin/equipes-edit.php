...
if (isset($_GET['equipe'])) {
    ...
    header("location: " . APP_URL . "/admin/equipes.php", true);
    exit();
}
        ...
        <div class="content">
            ...
            <main class="container py-5">
                ...
                if (isset($_POST['update'])) {
                    ...
                    if (empty($nbr_max) || is_null($nbr_max)) {
                    ...
                    if (empty($errorArray)) {
                        ...
                        SET  sport_id = :sport_id, coach_id = :coach_id, gender = :gender, title = :title, description = :description, price = :price, nbr_max = :nbr_max, salle = :salle, salle_id = :salle_id, emploi = :emploi
                        where id=:id");
                        ...
                        $updateEquipe->bindValue("nbr_max", $nbr_max);
                        $updateEquipe->bindValue("id", $selectedEquipeId);
                        $updateEquipe->bindValue("emploi", $emploi);
                        $updateEquipe->bindValue("salle", $salle);
                        $updateEquipe->bindValue("salle_id", $salleId);
                ...
                $oldNbr = isset($_POST['nbr']) ? $_POST['nbr'] : $equipe->nbr_max ;
                $oldPrice = isset($_POST['price']) ? $_POST['price'] : $equipe->price;
                $oldEmploi = isset($_POST['emploi']) ? $_POST['emploi'] : $equipe->emploi;
                $oldSalle = isset($_POST['salle']) ? $_POST['salle'] : $equipe->salle;
                $oldSalleId = isset($_POST['salle_id']) ? $_POST['salle_id'] : $equipe->salle_id;
                ?>
                ...
                <form class="form" method="POST">
                  ...
                  <!--<div class="form-group mb-3">
                    ...
                    <div class="form-group mb-3">
                        ...
                        <select class="form-select" aria-label="status" name="description" required>
                                <option value="disponible" <?= (isset($_POST['description']) && $_POST['description'] == 'disponible' || $equipe->description == 'disponble') ? 'selected' : ''; ?>>disponible</option>
                                <option value="plein" <?= (isset($_POST['description']) && $_POST['description'] == 'plein' || $equipe->description == 'plein') ? 'selected' : ''; ?>>plein</option>
                        </select>
                    </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="d-flex gap-3">
                                <div class="form-check">
                                    <input class="form-check-input" type="radio" name="gender" id="homme" value="homme" <?= (isset($_POST['gender']) && $_POST['gender'] == 'homme' || $equipe->gender == 'homme') ? 'checked' : ''; ?> checked required />
                                    <label class="form-check-label" for="homme">
                                        Homme
                                    </label>
                                </div>
                                <div class="form-check">
                                    <input class="form-check-input" type="radio" name="gender" id="femme" value="femme" <?= (isset($_POST['gender']) && $_POST['gender'] == 'femme' || $equipe->gender == 'femme') ? 'checked' : ''; ?> required />
                    ...
                    <div class="d-flex gap-4 mb-3">
                        ...
                        <div class="form-group w-25">
                            ...
                            <input type="number" name="salle_id" min="1" placeholder="Prix" class="form-control" id="salle_id" value="<?= $oldSalleId ?>" required />
                        </div>
                            
                               <div class="form-group w-25">
                            <label for="emploi" class="form-label">Emploi</label>
                            <textarea name="emploi" maxlength="100" class="form-control" placeholder="Emploi ..." id="emploi" aria-describedby="description" style="max-height: 100px; min-height:50px;" required><?= $oldEmploi ?></textarea>
                               </div> 
                               </div>
