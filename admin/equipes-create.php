...
*/
                    ...
                    if (empty($errorArray)) {
                        // modification nbr_max 
                        $createEquipe = $conn->prepare("INSERT INTO
                        equipes(sport_id, coach_id, gender, title,  price, nbr_max,nbr, emploi, salle, salle_id, status)
                        VALUES(:sport_id, :coach_id, :gender, :title , :price, :nbr_max, :nbr,:emploi, :salle, :salle_id, :status)");
                        ...
                        $createEquipe->bindValue("nbr_max", $nbr_max);
                        $createEquipe->bindValue("nbr", 0);
                  ...
                  <!--  <div class="form-group mb-3">
                    ...
                    <div class="d-flex gap-4 mb-3">
                        ...
                        <div class="form-group w-25">
                            ...
                            <textarea name="emploi" maxlength="100" class="form-control" placeholder="Emploi ..." id="emploi" aria-describedby="aria-describedby" style="max-height: 100px; min-height:50px;" required><?= $oldEmploi ?></textarea>
                    </div> 
