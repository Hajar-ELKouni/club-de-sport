...
<?php $equipes = $equipeObj->getEquipesByCoachPending($_SESSION['user']->id); ?>
...
if (isset($_POST['statusValue']) && isset($_POST['equipeID']))
{
    ...
    $demande = $equipeObj->updateStatusEquipe('Oui', $equipeID);
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <form method="POST" class="d-inline">
                                                ...
                                                <button class="btn btn-sm badge text-bg-secondary" name="equipeID" value="<?= $equipe->id ?>" type="submit">
                                                    En attente
                                                </button>
                                            </form>
                                        </td>
